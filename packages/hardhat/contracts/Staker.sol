...
contract Staker {
    ...
    // only "white-list" a single address
    address public contractWhitelisted;
  ...
  */
    ...
    constructor(address exampleExternalContractAddress) {
        ...
        contractWhitelisted = exampleExternalContractAddress;
    }
  ...
  */
    function resetWithdrawalDeadline(uint256 _seconds)
        public
        withdrawalDeadlineReached(true)
    {
        require(
            msg.sender == contractWhitelisted,
            "You are not the exampleExternalContract"
        );
  ...
  */
    function resetClaimDeadline(uint256 _seconds)
        public
